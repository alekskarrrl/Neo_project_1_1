--CALL ds.fill_account_turnover_f(to_date('2018-01-31','yyyy-mm-dd'));
--CALL dm.fill_f101_round_f(to_date('2018-01-31','yyyy-mm-dd'));
...
begin
    ...
    call dm.writelog( 'delete from dm_f101_round_f on_date = ' 
    ...
    call dm.writelog('[END] inserted to dm_f101_round_f ' ||  to_char(v_RowCount,'FM99999999') || ' rows.', 1);
