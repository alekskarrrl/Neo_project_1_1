-- CALL ds.fill_account_turnover_f(to_date('2018-01-10','yyyy-mm-dd'))
...
begin
	...
	call dm.writelog( '[BEGIN] fill_account_turnover_f(i_OnDate => date ''' 
         || to_char(i_OnDate, 'yyyy-mm-dd') 
         || ''');', 1
       );
    
    call dm.writelog( 'delete from dm_account_turnover_f on_date = ' 
    ...
    call dm.writelog('[END] inserted to dm_account_turnover_f ' || to_char(v_RowCount,'FM99999999') || ' rows.', 1);
